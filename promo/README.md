# AiAutomationBot — Promo Pack

**Tagline:** Add an AI assistant to your store in minutes.

A configurable support & sales chatbot with its own admin dashboard.
...
**Instagram**
> AiAutomationBot 🤖 — drop an AI assistant into your store in minutes. It answers product, order and delivery questions, captures leads, and ships with its own admin panel.

**LinkedIn**
> AiAutomationBot — a configurable AI support & sales assistant for online stores. Answers product, order and delivery questions, captures leads, and includes an admin control panel. Configured with one JSON file.

**X / Twitter**
> AiAutomationBot — add a GPT-powered support & sales assistant to your store in minutes. One JSON config.

**Facebook**
> AiAutomationBot adds an AI assistant to your store that answers questions and captures leads 24/7.

**GitHub (repo description / social preview alt)**
> AiAutomationBot — configurable AI support/sales chatbot with admin dashboard. Node/Express + OpenAI.

## Source screenshots

- `AiAutomationBot-main/promo/source-screenshots/01-shot-01-chat.png` (from `audit/screenshots/final-ready/AiAutomationBot/01-chat.png`)
- `AiAutomationBot-main/promo/source-screenshots/02-shot-02-admin.png` (from `audit/screenshots/final-ready/AiAutomationBot/02-admin.png`)
...
**Structure:** title card → main UI reveal → 3 feature callouts → second screen → CTA card (“Built by FlegarTech · Demo-ready product · github.com/flegartech/AiAutomationBot”).
**Audio:** none (silent by default). Add royalty-free music in an editor if desired.

**Suggested video caption (Reels / TikTok / Shorts):**
> AiAutomationBot demo 🤖 — an AI assistant answering store questions, plus its admin panel. One JSON config.

To rebuild: `node build-videos.mjs AiAutomationBot-main` (or `promo/scripts/build-video.sh`).
