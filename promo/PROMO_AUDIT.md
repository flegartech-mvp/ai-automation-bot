...
## Routes / screens used
- `audit/screenshots/final-ready/AiAutomationBot/01-chat.png` → shown as `yourstore.com`
- `audit/screenshots/final-ready/AiAutomationBot/02-admin.png` → shown as `yourstore.com/admin`
...
- `videos/01-instagram-reel.mp4` (5.6 MB)
- `videos/02-tiktok.mp4` (5.6 MB)
- `videos/03-youtube-short.mp4` (5.6 MB)
- `videos/04-linkedin-demo.mp4` (10.7 MB)
- `videos/05-x-demo.mp4` (7.7 MB)
- `videos/06-facebook-demo.mp4` (10.6 MB)
- `videos/07-github-readme-demo.mp4` (5.2 MB)
- `videos/08-portfolio-hero.mp4` (10.6 MB)
- `videos/gifs/github-readme-demo.gif` (5.5 MB)
- `videos/gifs/short-demo.gif` (7.8 MB)
...
**Screens/routes used:** Storefront chat, Admin dashboard.
